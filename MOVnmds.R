#' @title \code{"NMDS"} NMDS
#' @description
#' produce NMDS plot from \code{\link[vegan]{rda}}.
...
#' # Set a theme
#' require(ggplot2)
#' MOVnmds(Chemin.nmds, group = grl, fcol = "white", facol = "white") + theme_dark()
#'
#' # Remove the arrow
...
MOVnmds <- function(ord,groups = NULL, axes = c(1,2), obslab = FALSE, moblabs = NULL,
