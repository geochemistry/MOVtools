#' @title \code{"CCA"} CCA
#' @description
#' produce CCA plot from \code{\link[vegan]{rda}}.
...
#'
#' # Add a group
#' MOVcca(Spe.cca, group = grl)
#'
#' # Set a theme
#' require(ggplot2)
#' MOVcca(Spe.cca, group = grl, fcol = "white", facol = "white") + theme_dark()
#'
#' # Remove the arrow
#' MOVcca(Spe.cca, group = grl, spearrow = NULL)
#'
...
#' MOVcca(Spe.cca, group = grl, spearrow = NULL, ellipse = TRUE) +
#'   scale_colour_hue(l = 70, c = 300)

MOVcca <- function(ord, groups = NULL, axes = c(1,2), display = "bp", scaling = 2, obslab = FALSE, moblabs = NULL,
