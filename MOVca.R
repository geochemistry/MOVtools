#' @title \code{"CA"} CA
#' @description
#' produce CA plot from \code{\link[vegan]{rda}}.
...
#'
#' # Add a group
#' MOVca(Spe.ca, group = grl)
#'
#' # Set a theme
#' require(ggplot2)
#' MOVca(Spe.ca, group = grl, fcol = "white", facol = "white") + theme_dark()
#'
#' # Remove the arrow
#' MOVca(Spe.ca, group = grl, spearrow = NULL)
#'
...
#' MOVca(Spe.ca, group = grl, spearrow = NULL, ellipse = TRUE) +
#'   scale_colour_hue(l = 70, c = 300)

MOVca <- function(ord,groups = NULL, axes = c(1,2), scaling = 2, obslab = FALSE, moblabs = NULL,
